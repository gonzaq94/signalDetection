...
def display_spectrogram( f, t, Sxx) :
    ...
    #plt.colorbar()
    plt.axis('off')
    plt.savefig("/mnt/disque2/IMT/base/framePNG/AIS/AIS_2.png",bbox_inches = 'tight')
    #plt.show()

if __name__ == "__main__" :
    # Lecture d'un signal
    #[fe, x] = sp.io.wavfile.read('/media/sf_Shared/IMT/base/frame/AIS/AIS_1.wav')
    [fe, x] = sp.io.wavfile.read('/mnt/disque2/IMT/base/frame/AIS/AIS_2.wav')
    y = x[:,0] + 1j*x[:,1]
