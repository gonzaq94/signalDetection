...
def get_classifier():
    ...
    ********** Feature extraction layers ********** 
    ...
    model.add(Conv2D(filters=96, input_shape=(532,709,4), kernel_size=(11,11),strides=(4,4), padding='valid'))  #None, None
...
def train_and_evaluate(model, X_train, y_train, X_test, y_test, epochs=20, save=False):
    ...
    history=classifier.fit(X_train, y_train, batch_size=64, epochs=epochs, verbose=1,validation_split=0.2, shuffle=True, callbacks=[model_checkpoint])
#        #plots 
#        
